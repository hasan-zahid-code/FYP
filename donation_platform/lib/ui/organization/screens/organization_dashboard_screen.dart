...
final organizationTabIndexProvider = StateProvider<int>((ref) => 0);
...
class OrganizationDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Read the current tab index from the provider
    final currentIndex = ref.watch(organizationTabIndexProvider);
    ...
    return Scaffold(
      ...
      bottomNavigationBar: OrganizationBottomNav(
        ...
        onTap: (index) {
          // Update the index using the provider
          ref.read(organizationTabIndexProvider.notifier).state = index;
        },
      ),
    );
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildQuickActionButton(
                          ...
                          onTap: () {
                            ref
                                .read(organizationTabIndexProvider.notifier)
                                .state = 1;
                          },
                        ),
                        _buildQuickActionButton(
                    ...
                    donationsAsync.when(
                      ...
                      data: (donations) {
                        ...
                        final monetaryDonations =
                            donations.where((d) => d.amount != null);
                        ...
                        final itemDonations =
                            donations.where((d) => d.amount == null).length;
